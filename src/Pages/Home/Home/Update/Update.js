                    ...
                    <div className="mx-auto max-w-md">
                        ...
                        <form className="mt-6">
                            <div className="relative max-w-lg">
                                ...
                                <button
                                    className="absolute -ml-4 btn-lg end-1 top-1/2 -translate-y-1/2 rounded-md bg-sky-500 px-5 py-3 text-sm font-medium text-white transition hover:bg-blue-700"
                                >
                                    Join
                                </button>
                            </div>
